...
class BrowsableAPIEventStreamRenderer(BrowsableAPIRenderer):
    ...
    def get_context(self, data, accepted_media_type, renderer_context):
        ...
        if context['channels'] == '':
            context['channels'] = 'Here is no selected channels. Please check documentation to select channels or error.'
        ...
        if context['messages_types'] == '':
            context['messages_types'] = 'Here is no selected channels. Please check documentation to select channels or error.'
